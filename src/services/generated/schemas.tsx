...
export type WarehouseCommoditiesArgs = {
  sort?: Maybe<Scalars['String']>
  limit?: Maybe<Scalars['Int']>
  start?: Maybe<Scalars['Int']>
  where?: Maybe<Scalars['JSON']>
...
export type Mutation = {
  ...
  outboundCommodity?: Maybe<Commodities>
...
export type MutationOutboundCommodityArgs = {
  input?: Maybe<OutboundCommodityInput>
}
...
export type OutboundCommodityInput = {
  id?: Maybe<Array<Scalars['ID']>>
  destination: Scalars['String']
  delivery_time?: Maybe<Scalars['Date']>
  outbound_user: Scalars['ID']
}
